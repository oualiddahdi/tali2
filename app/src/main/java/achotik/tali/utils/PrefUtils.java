...
public class PrefUtils {
    ...
    private static final String PREVIOUS_INCOME = "previousIncome";
    ...
    public void setPreviousIncome(String key, @Nullable String value) {
        SharedPreferences prefs = mContext.getSharedPreferences(PREVIOUS_INCOME, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = prefs.edit();
        editor.putString(key, value);
        editor.apply();
    }
    ...
    public String getPreviousIncome(String key) {
        SharedPreferences prefs = mContext.getSharedPreferences(PREVIOUS_INCOME, Context.MODE_PRIVATE);
        return prefs.getString(key, DEFAULT_STRING_VALUE);
    }
    ...
    public Boolean isLoggedIN(){
        SharedPreferences sharedPreferences = mContext.getSharedPreferences(DEFAULT_PREFS,Context.MODE_PRIVATE);
        return sharedPreferences.getString(_Token,null) != null;
    }

    //this method will give the logged in user
    public PrefKey getToken() {
        SharedPreferences sharedPreferences = mContext.getSharedPreferences(DEFAULT_PREFS, Context.MODE_PRIVATE);
        return new PrefKey(
