package achotik.tali.controller;
    ...
    public class CountryCodeAdapter extends ArrayAdapter<CountryModel> {
        ...
        private View createItemView(int position, View convertView, ViewGroup parent) {
            ...
            if (resource == 0) {
                ...
                rootLayout.setBackgroundColor(context.getResources().getColor(R.color.backgroundPageDark));
                ...
                ccTextView.setBackgroundColor(context.getResources().getColor(R.color.backgroundPageDark));
                ccTextView.setTextColor(Color.BLACK);
                ccTextView.setPadding(10, 5, 10, 5);
                ccTextView.setTextSize(15);
                ccTextView.setText(model.getCountryFlag()+ "  (" + model.getPhoneCode() + ")");
