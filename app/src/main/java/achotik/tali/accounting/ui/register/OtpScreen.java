...
import achotik.tali.accounting.databinding.OtpScreenBinding;
import achotik.tali.accounting.databinding.PhoneAuthScreenBinding;
import achotik.tali.accounting.ui.home.HomeScreen;
import achotik.tali.controller.string.GroupTexts;
import achotik.tali.utils.PrefUtils;
...
public class OtpScreen extends AppCompatActivity {
    ...
    GroupTexts groupTexts = new GroupTexts();
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            prefUtils.setString(groupTexts.token,task.toString());
