...
@Database(entities = {CreditBookModel.class}, version = 1)
public abstract class CreditBookDatabase extends RoomDatabase {

    // below line is to create instance
    // for our database class.
    private static CreditBookDatabase instance;
    ...
    public static synchronized CreditBookDatabase getInstance(Context context) {
        ...
        if (instance == null) {
            ...
            instance =
                    ...
                    Room.databaseBuilder(context.getApplicationContext(),
                                    CreditBookDatabase.class, "course_database")
    ...
    private static class PopulateDbAsyncTask extends AsyncTask<Void, Void, Void> {
        PopulateDbAsyncTask(CreditBookDatabase instance) {
