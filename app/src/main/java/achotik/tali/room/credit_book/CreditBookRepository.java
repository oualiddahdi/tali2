...
public class CreditBookRepository {
    ...
    public CreditBookRepository(Application application) {
        CreditBookDatabase database = CreditBookDatabase.getInstance(application);
        dao = database.Dao();
    ...
    private static class InsertCourseAsyncTask extends AsyncTask<CreditBookModel, Void, Void> {
        private Dao dao;
        ...
        @Override
        protected Void doInBackground(CreditBookModel... model) {
    ...
    private static class UpdateCourseAsyncTask extends AsyncTask<CreditBookModel, Void, Void> {
        private Dao dao;
        ...
        @Override
        protected Void doInBackground(CreditBookModel... models) {
    ...
    private static class DeleteCourseAsyncTask extends AsyncTask<CreditBookModel, Void, Void> {
        private Dao dao;
